...
logvol /var --fstype="xfs" --name=lv_var --vgname=vg --size=2048
logvol /var/log --fstype="xfs" --name=lv_log --vgname=vg --size=512
logvol /var/log/audit --fstype="xfs" --name=lv_audit --vgname=vg --size=256
